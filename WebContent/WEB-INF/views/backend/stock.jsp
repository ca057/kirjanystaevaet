...
<div id="stockmgmt">
	...
	<section id="buecher">
		...
		<p>
			<em>Hinweis:</em> Vor dem Anlegen neuer Bücher müssen Kategorien und
			Autor:innen bereits existieren.
		</p>
		...
		<form action="bestand/buecher/add" method="POST"
			...
			<c:choose>
				...
				<c:otherwise>
					...
					<textarea rows="10" cols="50" maxlength="4096" name="description"
						id="buecher-anlegen-description" required></textarea>
					...
					<input type="text" id="buecher-anlegen-publisher" name="publisher"
					...
					<input type="number" min="0" max="2222" id="buecher-anlegen-year"
