...
/**
 * Class contains some methods that help to fill the Builder with data, the further goal is to keep the Entity-Objects immutable.
 * @author Madeleine
 */
...
public abstract class BuilderHelper {
	...
	/**
	 * 
	 * @param book contains Data to be saved in the BookBuilder
	 * @param bookBuilder
	...
	/**
	 * 
	 * @param author contains Data to be saved in the AuthorBuilder
	 * @param authorBuilder
	...
	/**
	 * 
	 * @param category contains Data to be saved in the CategoryBuilder
