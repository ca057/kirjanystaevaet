...
public interface OrderDAO {
	...
	/**
	 * @param order contains data to be stored
	 */
	public void updateOrder(Orderx order);
	/**
	 * Creates an Order, also takes care of stock and does all the linking between the Entities
	 * @param isbnsNumberOf {@link Map} that holds isbns of books to be ordered and their number as value
	 * @param userId
	 * @param cal
	 * @return
