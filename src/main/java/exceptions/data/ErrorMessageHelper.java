...
public abstract class ErrorMessageHelper {
	...
	/**
	 * Use if you may try to delete something that is still in relationship with
	 * some other entities
	 * 
	 * @param entity1
	 *            you try to delete
	 ...
	 *            contained in entity
	 * @param errormessage
	 *            original errormessage of the original exception
	 * @return
	 */
	public static String dataIntegrityViolation(String entity1, String entity2, String errormessage) {
		return String.format("%s kann only be deleted when it does not contain any %s %n Original ErrorMessage: %s",
				entity1, entity2, errormessage);
	}
	...
	/**
	 * Use if one tries to update a field which can not be updated, especially
	 * isbn
	 * 
	 * @param field
	 * @return
	 ...
	 *            of the object to be deleted
	 * @param information
	 *            further info like exception message
	 * @return
	 */
	public static String deletionFailed(String entity, String id, String information) {
		return String.format("Deletion of %s with id %s failed: %s", entity, id, information);
	}
