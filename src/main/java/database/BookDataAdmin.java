...
public interface BookDataAdmin {
	...
	public boolean addBookDesc(String isbn, String title, String desc, String price, String pub, String pubDate, String edition, String page, List<Integer> authorID, List<Integer> catId);
	...
	/**
	 * 
	 * @param dif Negative Integer if stock decreases, positive if increases
