...
public class WebConfig extends WebMvcConfigurerAdapter {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		if (registry != null) {
			registry.addResourceHandler("/css/**").addResourceLocations("/resources/css/").setCachePeriod(3600);
			registry.addResourceHandler("/js/**").addResourceLocations("/resources/js/").setCachePeriod(3600);
			registry.addResourceHandler("/img/**").addResourceLocations("/resources/img/", "/uploaded/img/")
					.setCachePeriod(3600);
			registry.addResourceHandler("/fonts/**").addResourceLocations("/resources/fonts/").setCachePeriod(3600);
		}
	}
