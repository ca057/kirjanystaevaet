...
%	\includesvg{files/db-schema}
	...
	Die Nutzeranalyse kann in der Perspektive auf die Datenbank in zwei Bereiche eingeteilt werden. Der eine arbeitet mit \texttt{Orderx} und \texttt{OrderItem}, die andere mit \texttt{User\-Book\-Statistic} and \texttt{visitCount}\\
