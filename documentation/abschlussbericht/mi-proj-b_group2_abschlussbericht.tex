...
\section{Umsetzung des Anforderungskatalogs}
	...
	\\
	\\
	Die Entitäten werden über die \textit{Data Access Objects (DAOs)} abgefragt. Diese sind \textit{Trans\-actio\-nal}. \textbf{Johannes, kannst du mehr dazu sagen?}\\To be continued
	\subsection{REST-API}
